...
function App() {
  ...
  return (
    <div className='w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat' style={{
      ...
      <div className='w-full max-w-md mx-auto border border-gray-50 rounded-lg p-5 backdrop-blur-lg bg-white/30'>
      <form onSubmit={(e)=>{
        e.preventDefault();
        convert()
      }}
...
/>
        ...
        <button className='w-full bg-blue-600 text-white px-4 rounded-lg'>
  ...
  // return <h2 style={{ color: "green" }}>APP WORKS</h2>
}
